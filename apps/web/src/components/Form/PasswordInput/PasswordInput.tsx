...
import { BaseInputStyleContainer, Error, Container } from '../TextInput/TextInput.styles';
	...
	return (
		<Container>
			<BaseInputStyleContainer hasError={!!error}>
				...
				<input ref={ref} type={isPasswordInput ? customType : type} id={id} {...rest} />
