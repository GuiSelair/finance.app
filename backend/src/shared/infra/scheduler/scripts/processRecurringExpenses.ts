...
import { InsertRecurringExpensesInNextMonthsService } from '../../../../modules/Expense/domain/services/InsertRecurringExpensesInNextMonthsService';
...
export default async function processRecurringExpenses() {
  try {
    ...
    const insertRecurringExpensesInNextMonthsService = container.resolve(
      InsertRecurringExpensesInNextMonthsService,
    );
